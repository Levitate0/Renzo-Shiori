...
public class ReaderChapterDto
{
    ...
    /// <summary>Paid/locked chapter that must be purchased on the source site.</summary>
    [JsonPropertyName("locked")]
    public bool Locked { get; set; }

    /// <summary>Absolute source-site URL for the chapter (purchase/unlock page).</summary>
...
public class PreviewPagesDto
{
    ...
    /// <summary>
    /// True when the source refused the pages because the chapter must be
    /// purchased/unlocked (0 pages, or a "requires purchase / log in via webview"
    /// error). The reader shows its locked screen and keeps polling.
    /// </summary>
    [JsonPropertyName("locked")]
    public bool Locked { get; set; }
}
