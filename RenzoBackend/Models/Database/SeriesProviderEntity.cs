...
public class SeriesProviderEntity : ProviderSummaryBase, IBridgeItemInfo, IThumb
{
    ...
    /// <summary>
    /// This provider is the authority for the series-level release status
    /// (ongoing / completed / hiatus …). Exactly one provider per series should
    /// carry this; it defaults to the permanent (storage) source.
    /// </summary>
