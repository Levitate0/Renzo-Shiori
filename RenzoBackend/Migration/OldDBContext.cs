        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Import>(entity =>
            {
                ...
                entity.Property(i => i.Action)
                    .IsRequired()
                    .HasDefaultValue(RenzoBackend.Models.Action.Add)
                    .HasConversion<int>();
                // Configure JSON conversion for ImportSeriesSnapshot
                entity.Property(i => i.Info)
                    .HasConversion(
                        v => JsonSerializer.Serialize(v, new JsonSerializerOptions { WriteIndented = false }),
                        v => JsonSerializer.Deserialize<RenzoBackend.Models.ImportSeriesSnapshot>(v, new JsonSerializerOptions { WriteIndented = false }) ?? new RenzoBackend.Models.ImportSeriesSnapshot()
                    ).Metadata.SetValueComparer(GenericValueComparer.Create<RenzoBackend.Models.ImportSeriesSnapshot>());
