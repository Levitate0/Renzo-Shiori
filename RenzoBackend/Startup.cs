...
namespace RenzoBackend
{
    public class Startup
    {
        ...
        public ILogger Logger
        {
            ...
            {
                if (_logger == null)
                    _logger = LoggerInfrastructure.CreateAppLogger<Startup>(EnvironmentSetup.AppRenzo);
                return _logger;
            }
        }
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddRenzoJsonService();   // Singleton: shared per-file lock for renzo.json atomicity
