...
namespace RenzoBackend.Extensions
{
    ...
    public static class FileSystemExtensions
    {
        ...
        /// <summary>
        /// Loads ImportSeriesSnapshot from a directory's renzo.json file
        /// </summary>
        ...
        {
            var renzoJsonPath = Path.Combine(seriesFolder, "renzo.json");
            ...
            {
                logger?.LogWarning("Error parsing renzo.json in {seriesFolder}: {message}", seriesFolder, ex.Message);
                return null;
            }
        }
        ...
        public static Stream StreamEmbeddedResource(string resourceName)
        {
            ...
            string resourcePath = $"RenzoBackend.Resources.{resourceName}";
