...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RenzoBackend.Models.Database.EnqueueEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RenzoBackend.Models.Database.EtagCacheEntity", b =>
                {
                    b.Property<string>("Key")
                        .HasColumnType("TEXT")
                        .UseCollation("BINARY");
            ...
            modelBuilder.Entity("RenzoBackend.Models.Database.HealthStatusEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("RenzoBackend.Models.Database.ImportEntity", b =>
                {
            ...
            modelBuilder.Entity("RenzoBackend.Models.Database.JobEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RenzoBackend.Models.Database.LatestSerieEntity", b =>
                {
            ...
            modelBuilder.Entity("RenzoBackend.Models.Database.ProviderStorageEntity", b =>
                {
                    b.Property<string>("MihonProviderId")
                        .HasColumnType("TEXT")
                        .UseCollation("BINARY");
            ...
            modelBuilder.Entity("RenzoBackend.Models.Database.SeriesEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                    ...
                    b.Property<string>("ScrobblerType")
                        .HasColumnType("TEXT")
                        .HasAnnotation("Relational:JsonPropertyName", "scrobblerType");
            ...
            modelBuilder.Entity("RenzoBackend.Models.Database.SeriesProviderEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RenzoBackend.Models.Database.SettingEntity", b =>
                {
                    b.Property<string>("Name")
                        .HasColumnType("TEXT")
                        .UseCollation("BINARY");
            ...
            modelBuilder.Entity("RenzoBackend.Models.Database.SeriesProviderEntity", b =>
                {
                    b.HasOne("RenzoBackend.Models.Database.SeriesEntity", null)
                        .WithMany("Sources")
