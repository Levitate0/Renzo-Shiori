...
namespace RenzoBackend.Services.Import.KavitaParser;
...
public class ComicInfo
{
    ...
    public AgeRating ConvertAgeRatingToEnum(string value)
    {
        if (string.IsNullOrEmpty(value)) return KavitaParser.AgeRating.Unknown;
        return Enum.GetValues<AgeRating>()
            .SingleOrDefault(t => t.ToDescription().ToUpperInvariant().Equals(value.ToUpperInvariant()),
                KavitaParser.AgeRating.Unknown);
    }
