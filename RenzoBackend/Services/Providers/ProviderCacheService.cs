...
namespace RenzoBackend.Services.Providers
{
    ...
    public class ProviderCacheService
    {
        ...
        {
            // Sources without a "latest updates" listing still get a catalog job —
            // UpdateSourceAsync falls back to the popular listing for them, so they
            // populate Browse instead of staying permanently empty.
