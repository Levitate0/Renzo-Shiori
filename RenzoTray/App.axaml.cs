...
using RenzoTray.Utils;
using RenzoTray.Views;
using java.awt;
...
public partial class App : Application
{
    ...
    private async Task StartApplication()
    {
        try
        {
            ...
            _host = RenzoBackend.Program.CreateHostBuilder(Array.Empty<string>()).Build();
    ...
    private void SetupTrayIcon()
    {
        try
        {
            ...
            try
            {
                var uri = new Uri("avares://RenzoTray/Assets/renzo.ico");
