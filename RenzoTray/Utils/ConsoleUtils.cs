...
public static class ConsoleUtils
{
    ...
    /// <summary>
    /// Sets the console window icon using the renzo.ico from embedded resources.
    /// </summary>
    ...
    /// <summary>
    /// Loads the renzo.ico icon from the embedded resource.
    /// </summary>
    ...
    private static IntPtr LoadIconFromResource()
    {
        try
        {
            ...
            if (stream == null)
            {
                SafeWriteLine("Could not find any embedded resource for renzo.ico");
