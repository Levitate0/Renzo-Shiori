...
export interface Settings {
  ...
  /** Max concurrent HTTP requests per host (OkHttp). 5–12. Higher = faster but more ban risk. */
...
export interface ReaderChapter {
  ...
  /** Paid/locked chapter that must be purchased on the source site. */
  locked?: boolean;
  /** Absolute source-site URL for the chapter (purchase/unlock page). */
  url?: string | null;
}
...
export interface ChapterDetail {
  ...
  /** ISO 8601 date the source reported the chapter was uploaded; null if unknown. */
