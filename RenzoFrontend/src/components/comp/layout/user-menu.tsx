    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-60">
          ...
          {/* Account — every user level. Personal/sensitive settings that
              belong to the signed-in user (site logins, etc.), as opposed to
              /settings below which is app-wide config, Owner only. */}
          <DropdownMenuItem asChild>
            <Link
              href="/account"
              className="flex items-center gap-2 cursor-pointer"
