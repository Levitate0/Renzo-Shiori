...
function PillToggle({
  ...
  return (
    ...
    >
      ...
      />
      {/* The card lives in a narrow sidebar column, so always use the short
          label; the full label stays available as the tooltip. */}
      <span title={label}>{shortLabel ?? label}</span>
    </button>
  );
}
...
export const ProviderCard = ({
  ...
  onUseStatusChange: (providerId: string, enabled: boolean) => void;
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-start gap-3">
        ...
        <div className="shrink-0">
          <img
            ...
            onError={(e) => {
              ...
              if (
                target.src !==
                window.location.origin + "/renzo.png"
              ) {
        ...
        {/* Right controls */}
        {canEdit && (
          <div className="flex w-full flex-wrap items-center gap-2 border-t border-border/40 pt-3">
            {!isUnknown && (
              <>
                <div className="flex flex-wrap items-center gap-1">
                  ...
                  <PillToggle
                    ...
                    shortLabel="Status"
                    checked={useStatus}
                    onChange={(v) => onUseStatusChange(provider.id, v)}
                    disabled={isDisabled}
                  />
                </div>
