...
export default function QueuePage() {
  ...
  // Each user's queue is isolated to their own library. Owner-level accounts
  // can flip to every user's queue for support/troubleshooting.
            ...
            <div className="flex items-center gap-2 text-xs text-muted-foreground">
              {canOwner && (
                <button
                  ...
                  title={viewAllLibraries ? "Showing every user's queue — click to view only your own" : "Showing only your queue — click to view every user's"}
