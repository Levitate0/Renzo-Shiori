...
export default function RootPage() {
  ...
  // Each user's library is isolated. Owner-level accounts can flip to "All
  // libraries" (every user's series) for support/troubleshooting; everyone
          ...
          <div className="ml-auto flex items-center gap-2 shrink-0">
            {canOwner && (
              <button
                ...
                title={viewAllLibraries ? "Showing every user's library — click to view only your own" : "Showing only your library — click to view every user's"}
                className={`inline-flex items-center gap-1.5 rounded-full border px-3 py-1 text-[11px] font-medium transition-colors h-8 whitespace-nowrap ${
                  viewAllLibraries
